    ...
    <section id="about" className="py-24 scroll-mt-16">
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2">
            <h2 className="text-gray-900 dark:text-gray-100 text-4xl font-bold mb-4">About Me</h2>
        ...
        <div className="md:w-1/2">
            <div className="border-blue-700/50 dark:border-blue-500/50 relative border-4 rounded-lg group">
                ...
                <div className="bg-gray-200 dark:bg-gray-800 absolute inset-0 rounded-lg transform translate-x-4 translate-y-4 transition-transform duration-300"></div>
            </div>
        </div>
      </div>
    </section>
