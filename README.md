...
| 💬 **[Interactive Portfolio & AI Chatbot](https://github.com/Sharv619/your-portfolio-repo-name)** | An **interactive AI chatbot** built into my portfolio website, demonstrating a **RAG system** for context-aware career advice. It leverages a **47-page knowledge base** and the **Google Gemini API**. | **Next.js, React 19, TypeScript, Gemini API, RAG, Vector Embeddings, Local Storage** |
