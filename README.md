...
| :--- | :--- | :--- |
| 🤖 **[codeflow-hook: AI Code Review Platform](https://github.com/Sharv619/codeflow-commander---nexus-gateway)** | An open-source npm package with **500+ First week downloads**. It's a multi-agent AI system using RAG for context-aware code analysis, integrated directly into the Git workflow as a pre-commit hook. | **Node.js, TypeScript, Gemini API, RAG, Vector Embeddings, Git Hooks** |
| 📈 **[ReliBoard: Full-Stack PM Application](https://github.com/Sharv619/reliboard)** | A production-ready, enterprise-grade project management application. Features JWT-based auth with Role-Based Access Control (RBAC), a full test suite with 85%+ coverage, and is fully containerized with Docker. | **React, Node.js, TypeScript, MongoDB, Docker, JWT, Jest** |
| 🔥 **[Mission-Critical System Recovery & Overhaul](https://github.com/Sharv619/production-incident-response-case-study)** | As the sole engineer, I led a complete system recovery, restoring **100% of critical data** after a production outage. I also re-architected the frontend, improving site performance by **88%** (25s to <3s). | **Full-Stack, Nginx, Incident Response, Performance Tuning** |
| 💬 **[Interactive Portfolio & AI Chatbot](https://github.com/Sharv619/Sharv619.github.io)** | A modern portfolio built with the **Next.js 16 App Router**. Features an integrated, context-aware AI chatbot powered by the **Any AI model** to provide detailed answers about my career and projects(just a preview to my private project) . | **Next.js, React 19, TypeScript, Tailwind CSS, Framer Motion, Google AI SDK** |
...
I'm actively seeking new opportunities and am always open to connecting with fellow builders.
