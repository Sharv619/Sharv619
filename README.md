...
| 💬 **[Interactive Portfolio & AI Chatbot](https://github.com/Sharv619/Sharv619.github.io)** | An **interactive AI chatbot preview** built into my portfolio website, demonstrating a **RAG system** for context-aware career advice. It leverages a **47-page knowledge base** which can be embeded with **Google Gemini API**. | **Next.js, React 19, TypeScript, Gemini API, RAG, Vector Embeddings, Local Storage** |
